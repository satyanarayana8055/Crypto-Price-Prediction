...
class ModelService:
    ...
    def load_models(self, coin: str):
        ...
        try:
            ...
            best_model_path = os.path.join(DATA_PATHS['perform_metrics'], f'{coin}_performance_metrics.csv')    
    ...
    def predict(self, coin: str = 'bitcoin') -> Dict:
        try: 
            ...
            current_price = features_df.iloc[-1]['price'] if 'price' in features_df.columns else 0
            ...
            return {
                ...
                'price_change_percentage': float((prediction - current_price) / current_price * 100) if current_price > 0 else 0,
